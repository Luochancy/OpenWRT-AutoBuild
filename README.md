...
- Generate `.config` files using [ImmortalWrt v24.10.5](https://github.com/immortalwrt/immortalwrt/tree/v24.10.5) source code. ( You can change it through environment variables in the workflow file. )
- Push `.config` file to the GitHub repository.
- Select `Build OpenWrt` or the self-hosted ImmortalWrt workflow on the Actions page.
...
This configuration includes sysupgrade firmware generation support for ImmortalWrt. The build process will generate firmware files that can be used for online system upgrades.
